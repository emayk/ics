...
class ImagesController extends Base {
 protected  $images;
    function __construct(ImagesInterface $images)
    {
        $this->images = $images;
    }

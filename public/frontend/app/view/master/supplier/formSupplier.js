Ext.define('App.view.master.supplier.formSupplier',{
	...
	items: [
			{xtype: 'fieldset', title: 'Information', defaults : { anchor : '100%',allowBlank: false, forceSelection: isDebug() ? false : true }, items: [
						...
						{ name: 'createby_id', xtype: 'hiddenfield', value: getIdLogin() },
						{ name: 'lastupdateby_id', xtype: 'hiddenfield', value: getIdLogin() },
			...
			{xtype : 'fieldset', title : 'Address', layout: 'anchor', defaults : { anchor : '100%',allowBlank: false, forceSelection: isDebug() ? false : true }, items: [
						{ name : 'negara_id',fieldLabel : 'Country', xtype: 'cbCountries',valueNotFoundText: 'Please Select Country', value: isDebug() ? 1 : null },
						{ name : 'province_id',fieldLabel : 'Province', xtype: 'cbProvinces',valueNotFoundText: 'Please Select Province', value: isDebug() ? 6 : null },
						{ name : 'city_id',fieldLabel : 'City', xtype: 'cbCities',valueNotFoundText: 'Please Select Cities',value: isDebug() ? 2 : null } ,
						{ name : 'alamat',height : 100,
						fieldLabel :'Address', xtype: 'textareafield'/*, anchor: '100%'*/, grow : true, value: isDebug() ?randomString(200) : null },

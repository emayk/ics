...
*
* Bussiness Logic Paymenttype
*
**/

namespace Emayk\Ics\Repo\Paymenttype;
use Carbon\Carbon;
use Illuminate\Support\Facades\Auth;
use \Response;
use \Input;

class PaymenttypeEloquent implements PaymenttypeInterface{
    ...
    /**
    *
    * Mendapatkan Record Paymenttype berdasarkan ID yang diberikan
    * @param  int $id ID Record
    * @return Model Record Paymenttype
    **/
...
//            ->orderBy('id','DESC')
    ...
    public function store()
    {
        ...
        return Response::json(array(
            'success' => $saved,
            'results' => $this->paymenttype->toArray()
        ))->setCallback();
    }

    /**
     * Menghapus Paymenttype
     *
     * @param $id
     * @return mixed
     *
...
//         $db->name = Input::get('name');
    ...
    **/
    ...
    /**
    *
    * Menampilkan Page Create data Paymenttype
    *
    **/

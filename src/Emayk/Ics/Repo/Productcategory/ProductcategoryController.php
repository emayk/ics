...
class ProductcategoryController extends Base {
 protected  $productcategory;
    function __construct(ProductcategoryInterface $productcategory)
    {
	...
	{
		return $this->productcategory->store();
	}
	...
	{
			return $this->productcategory->show($id);
	}
	...
	{
			return $this->productcategory->update($id);
	}

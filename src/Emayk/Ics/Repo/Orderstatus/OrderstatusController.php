...
class OrderstatusController extends Base {
 protected  $orderstatus;
    function __construct(OrderstatusInterface $orderstatus)
    {
	...
	{
			return $this->orderstatus->show($id);
	}
	...
	{
			return $this->orderstatus->edit($id);
	}
	...
	{
			return $this->orderstatus->update($id);
	}

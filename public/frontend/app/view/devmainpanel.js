...
Ext.define('App.view.devmainpanel', {
	...
	plain: true,
	items: [
		{ xtype: 'appdashboardvdashboard', title: 'Dashboard Development', iconCls: 'home', closable: false},
		{ xtype: 'productimport', title: 'Import Produk', iconCls: 'product', closable: false},

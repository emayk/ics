...
<body>
<div id="bg"><img src="{{ Icsview::asset('frontend/images/logologin.png') }}"  alt=""> </div>
...
<script type="text/javascript" src="{{ Icsview::asset('frontend/login.js')}}"></script>
</body>
</html>

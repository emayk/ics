...
*
* Bussiness Logic Warehousecategory
*
**/
...
class WarehousecategoryEloquent implements WarehousecategoryInterface{
    protected $warehousecategory;
    function __construct(Warehousecategory $warehousecategory)
    {
    ...
    **/
    ...
    public function find($id){
        return $this->warehousecategory->find($id);
    }
    ...
    public function store()
    {
        ...
        return Response::json(array(
            'success' => $saved,
            'results' => $this->warehousecategory->toArray()
        ))->setCallback();
    }
    ...
    public function delete($id)
    {
        ...
        if ($this->hasAccess())
        {
            $deleted = $this->warehousecategory
                ->find($id)
                ->delete();
   ...
   public function show($id)
    ...
    {
        return $this->warehousecategory->get(array('name','id') )->toArray();

...
/*==========  Window  ==========*/
            ...
            'winWizCreateOrder' : { render : me.onRender_window },
...
/*==========  Page 6 Handler  ==========*/
    ...
    addSupplier : function  (recordSup,recProduct) {
        ...
        var product = me.productSelectedStore.findRecord('product_id', supplier.get('product_id') );
    ...
    on_page6_sentToServer: function(){
        ...
        Ext.each(store.data.items,function(item,key){
                var a = {
                    ...
                    // sup_name: item.get('sup_name') ,
                    // wh_alamat: item.get('wh_alamat') ,
        ...
        order.save();
        Ext.each(data,function(value,key){
            log('Key ==>',value);
            log('Value ==>',key);
        });
        log('Data Setelah Iterasi', data);
    },
/**
*
* Begin Logic
...
on_page3_deleteProductSupplierActionColumn: function(column, action, grid, rowIndex, colIndex, item, e) {
    ...
    on_gridProductSelected_DblClick: function( grid, record, item, index, e, eOpts ){
        ...
        var productId = parseInt( recProduct.get('product_id') );
        log(productId);
        var ada = me.SupplierSelectedStore.findRecord('product_id',productId,0);

        //cek apakah record id product sudah ada distore,
        //ya : stop (abaikan)
        //
        if (ada !== null){
...
/*(Page 2) Reconfigure Supplier Product Selected*/
        ...
        // me.SupplierSelectedStore.loadPage(1);
...
/*(Page 3) Reconfigure Supplier Product Selected*/
        ...
        me.SupplierSelectedStore.loadPage(1);
        me.ContactSelectedStore.loadPage(1);

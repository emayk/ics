...
class OrdertypeController extends Base {
 protected  $ordertype;
	...
	{
			return $this->ordertype->update($id);
	}
	...
	{
			return $this->ordertype->destroy($id);
	}

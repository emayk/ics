...
//		Route::resource('order/item', '\Emayk\Ics\Repo\Transaction\Purchase\Order\Item\Controller');
	...
	Route::group(['prefix' => 'receive'], function () {
		Route::resource('good', '\Emayk\Ics\Repo\Transaction\Receive\Product\Controller');
	});
//
});

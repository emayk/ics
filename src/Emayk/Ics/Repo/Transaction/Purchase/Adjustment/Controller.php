...
class Controller extends BaseController{
	...
	function __construct(iAdjustment $Adjustment)
	{
	...
	{
		return $this->adjustment->edit($id);
	}
	...
	{
		return $this->adjustment->update($id);
	}

<?php namespace Emayk\Ics {
    ...
    class IcsServiceProvider extends ServiceProvider
    {
        ...
        protected function registerExtjs()
        {
        ...
        protected function registerOutput()
        {
        ...
        protected function registerExportDompdf()
        {
        ...
        {
            return $this->registerShare($name, $class);
        }
        ...
        protected function registerShare($name, $concrete)
        {
        ...
        {
            return $this->registerBindIf($interface, $class);
        }


        protected function registerBindIf($interface, $concrete)
        {

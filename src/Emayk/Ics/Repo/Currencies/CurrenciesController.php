...
class CurrenciesController extends Base {
 protected  $currencies;
    function __construct(CurrenciesInterface $currencies)
    {
	...
	{
			return $this->currencies->show($id);
	}
	...
	{
			return $this->currencies->update($id);
	}

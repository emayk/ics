...
class TaxtypeEloquent implements TaxtypeInterface{
    protected $taxtype;
    function __construct(Taxtype $taxtype)
    {
    ...
    /**
    *
    * Mendapatkan Record Taxtype berdasarkan ID yang diberikan
    * @param  int $id ID Record
    * @return Model Record Taxtype
    **/

    public function find($id){
        return $this->taxtype->find($id);
    }

    /**
     * Mendapatkan Semua Taxtype
     * @return mixed
     */
    public function all()
    {
